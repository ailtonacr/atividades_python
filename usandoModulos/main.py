...
def view_result(message):
    """
    Função que recebe uma mensagem e a imprime na tela.
    :param message: Fornece a mensagem a ser impressa na tela.
    """
    print(message)
...
def trate_dict():
    """
    Gera um dicionário com 10 valores aleatórios e passa esse dicionário para a função process_dict,
    que retorna um dicionário contendo a soma total, a média e a variação desses valores.
    """
